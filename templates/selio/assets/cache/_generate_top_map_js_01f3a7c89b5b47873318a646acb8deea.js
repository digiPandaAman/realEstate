...
$(document).ready(function(){
    ...
    if($('#main-map').length){    
        ...
        var positron = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}{r}.png').addTo(map);
            ...
            marker.bindPopup("<!--Widget-preview-category-path: --><div class=\"infobox map-box\">    <a href=\"https://digipanda.biz/realEstate/index.php/property/7/en/toplice_bliznec\" class=\"listing-img-container\">        <div class=\"infoBox-close\"><i class=\"fa fa-times\"></i>        </div><img src=\"https://digipanda.biz/realEstate/files/strict_cache/575x500386182116_5e4c8542ab_b.webp\" alt=\"Toplice Bliznec\">        <div class=\"rate-info\">                    <h5>                                                $40,000 /  $400                                        </h5>                    <span class=\"purpose-Prodaja i najam\">                Prodaja i najam            </span>         </div>        <div class=\"listing-item-content\">            <h3>Toplice Bliznec</h3>            <span><i class=\"la la-map-marker\"></i>Bliznec 34z, Zagreb</span>        </div>    </a></div>", jpopup_customOptions);
            clusters.addLayer(marker);
            markers.push(marker);
