                ...
                <?php if(!empty($estate_data_option_36) || !empty($estate_data_option_37)): ?>
                    <?php if(_ch($estate_data_option_4, false) && stripos($estate_data_option_4, lang_check('Rent'))!==FAlSE):?>
                        <?php 
                            ...
                            if(!empty($estate_data_option_36)) echo $options_prefix_36.' '.$estate_data_option_36; //echo show_price($estate_data_option_36, $options_prefix_36, $options_suffix_36, $lang_id);
                        ?>
                    <?php else:?>
                        <?php 
                            if(!empty($estate_data_option_36)) echo $options_prefix_36.' '.$estate_data_option_36; //echo show_price($estate_data_option_36, $options_prefix_36, $options_suffix_36, $lang_id);
