...
<div class="col-xl-3 col-sm-6 col-md-4 widget_edit_enabled">
    <div class="bottom-logo">
        <?php if(!empty($website_logo_url) && stripos($website_logo_url, 'assets/img/logo.png') === FALSE):?>
            <!--<img width="220" src="<?php echo $website_logo_url; ?>" alt="{settings_websitetitle}" class="img-fluid">-->
            <img width="220" src="<?=base_url('files/footer-logo.png');?>" alt="{settings_websitetitle}" class="img-fluid">
        <?php elseif(false):?>
            <?php
